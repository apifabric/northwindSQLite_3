...
resourcename="01j9v4whwprtjnya9psvnsy9sp"  # lower case, only
resourcegroup="01j9v4whwprtjnya9psvnsy9sp_rg"
...
# git clone https://github.com/apilogicserver/01j9v4whwprtjnya9psvnsy9sp.git
# cd 01j9v4whwprtjnya9psvnsy9sp
...
az group create --name 01j9v4whwprtjnya9psvnsy9sp_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group 01j9v4whwprtjnya9psvnsy9sp_rg --sku S1 --is-linux
az container create --resource-group 01j9v4whwprtjnya9psvnsy9sp_rg --name 01j9v4whwprtjnya9psvnsy9sp --image apilogicserver/01j9v4whwprtjnya9psvnsy9sp:latest --dns-name-label 01j9v4whwprtjnya9psvnsy9sp --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//01j9v4whwprtjnya9psvnsy9sp.westus.azurecontainer.io:5656'
